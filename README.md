...
Una variable de plantilla definida en `commons.json` puede ser utilizada en un template para definir un valor de un estilo al igual que se coloca en un arvhico HTML.
