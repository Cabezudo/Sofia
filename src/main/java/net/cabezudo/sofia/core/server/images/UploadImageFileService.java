...
import net.cabezudo.sofia.core.server.files.AbstractUploadFilesService;
 ...
 */
public class UploadImageFileService extends AbstractUploadFilesService {
  ...
  protected Path getFileTargetPath() {
    return site.getVersionedSourcesImagesPath();
  }
