...
public class WebServicesUniverse {
  ...
  public void runGET(HttpServletRequest request, HttpServletResponse response, Tokens tokens)
  ...
  public void runPOST(HttpServletRequest request, HttpServletResponse response, Tokens tokens)
          throws ClassNotFoundException, NoSuchMethodException, InstantiationException, IllegalAccessException, IllegalArgumentException, InvocationTargetException, ServletException, WebServiceNotFoundException {
    run(request, response, tokens, post);
  }

  public void runDELETE(HttpServletRequest request, HttpServletResponse response, Tokens tokens)
          throws ClassNotFoundException, NoSuchMethodException, InstantiationException, IllegalAccessException, IllegalArgumentException, InvocationTargetException, ServletException, WebServiceNotFoundException {
    run(request, response, tokens, delete);
  }

  public void runPUT(HttpServletRequest request, HttpServletResponse response, Tokens tokens)
          throws ClassNotFoundException, NoSuchMethodException, InstantiationException, IllegalAccessException, IllegalArgumentException, InvocationTargetException, ServletException, WebServiceNotFoundException {
    run(request, response, tokens, put);
  }

  private void run(HttpServletRequest request, HttpServletResponse response, Tokens tokens, WebServices webServices)
          throws ClassNotFoundException, NoSuchMethodException, InstantiationException, IllegalAccessException, IllegalArgumentException, InvocationTargetException, ServletException, WebServiceNotFoundException {
